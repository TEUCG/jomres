...
class plugin_info_je_mapview
	...
	function __construct()
		...
		$this->data=array(
			...
			"manual_link"=>'',
			'change_log'=>'v3.1 updated marker cluserer javascript. v3.2 Modified functionality to use new get_property_details_url function. v3.4 Settings moved to site config. v3.5 Settings moved to site config gmaps tab. ',
			'highlight'=>'',
