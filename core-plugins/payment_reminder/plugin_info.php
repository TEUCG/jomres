...
class plugin_info_payment_reminder
	...
	function __construct()
		...
		$this->data=array(
			...
			"manual_link"=>'',
			'change_log'=>'v3.1 Settings moved to Site Config v3.2 Plugin updated to work with Jomres data encryption of user details. v3.3 Use of "secret" in cron tasks removed. It is not necessary and is unreliable.',
			'highlight'=>'',
