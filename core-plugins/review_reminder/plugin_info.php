...
class plugin_info_review_reminder
	...
	function __construct()
		...
		$this->data=array(
			...
			"manual_link"=>'',
			'change_log'=>'v2.1 Settings moved to Site Config v2.2 Modified how array contents are checked. v2.3 Plugin updated to work with Jomres data encryption of user details. v2.4 Use of "secret" in cron tasks removed. It is not necessary and is unreliable.',
			'highlight'=>'',
