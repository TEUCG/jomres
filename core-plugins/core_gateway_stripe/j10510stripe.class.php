...
class j10510stripe
	...
	function __construct()
		...
		$notes = jr_gettext( "STRIPE_CONNECT_CONFIG_INFO", 'STRIPE_CONNECT_CONFIG_INFO', false, false )."<br/>".jr_gettext('_JOMRES_CUSTOMTEXT_GATEWAY_CONFIG_NOTES'.$plugin, $str." ".JOMRES_SITEPAGE_URL_NOSEF.'/index.php?option=com_jomres&task=stripe_connect_return&topoff=1&tmpl=jomres');
