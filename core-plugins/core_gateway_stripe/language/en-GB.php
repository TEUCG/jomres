...
jr_define('STRIPE_CONNECT_SITE_CONFIG_CLIENT_ID_DESC',"You can get your Stripe Client ID from your <a href='https://dashboard.stripe.com/account/applications/settings' target='_blank'>Dashboard.</a>");
jr_define('STRIPE_CONNECT_SITE_CONFIG_RETURN_URL',"Please ensure that you set your Redirect URI in App Settings > Connect > Platform settings to <br/> ");
