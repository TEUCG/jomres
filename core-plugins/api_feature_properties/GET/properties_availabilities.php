...
/*
	** Title | Get Dashboard events between certain dates.
	** Description | This function replicates the ajax call that initially builds the dashboard data.
	** Plugin | api_feature_properties
	** Scope | properties_get
	** URL | properties
 	** Method | GET
	** URL Parameters | properties/:ID/availabilities/dashboard/:START_DATE/:END_DATE
	** Data Parameters | None
	...
	** Error Response | 403 "User attempted to access a property that they don't have rights to access"
	** Sample call |jomres/api/properties/2/availabilities/dashboard/2016-05-20/2016-05-22
	** Notes |
*/

Flight::route('GET /properties/@id/availabilities/dashboard/@start/@end', function( $property_uid , $start , $end) 
	{
	validate_scope::validate('properties_get');
	validate_property_access::validate($property_uid);
