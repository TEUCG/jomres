...
class plugin_info_embed_availability_calendar
	...
	function __construct()
		...
		$this->data=array(
			...
			'change_log'=>'1.1 Jomres 9.7.4 related changes v1.2 Jomres 9.7.4 related changes v1.3 Remaining globals cleanup and jr_gettext refactor related changes. v1.4 Notices fixes. v1.5 Frontend menu refactored. v1.6 Removed a check for admin area to allow scripts to call frontend menu in the administrator area.',
			'highlight'=>'',
