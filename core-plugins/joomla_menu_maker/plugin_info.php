...
class plugin_info_joomla_menu_maker
	...
	function __construct()
		...
		$this->data=array(
			...
			'change_log'=>' v0.9 BS3 template related tweaks. v1.0 PHP7 related maintenance. v1.1 Improved how menus are saved. v1.2 Added proper class constructor v1.3 Fixed a couple of notices, resolved some issues where the J code could complain about Locking problems, and added code to build a new Alias if the current one already exists.',
			'highlight'=>'',
			'image'=>'',
			'demo_url'=>'',
