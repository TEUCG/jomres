...
class j00501ical
	...
	function __construct( $componentArgs )
		...
		$iCalIncludeEnquiries = jomresHTML::selectList( $yesno, 'cfg_iCalIncludeEnquiries', 'class="inputbox" size="1"', 'value', 'text', $mrConfig[ 'iCalIncludeEnquiries' ] );
		$iCalAnonymousFeed = jomresHTML::selectList( $yesno, 'cfg_iCalAnonymousFeed', 'class="inputbox" size="1"', 'value', 'text', $mrConfig[ 'iCalAnonymousFeed' ] );
